...
const ENEMY_TYPES = {
  ...
  emeritus:  { nm:'Senior Partner Emeritus',hp:650, spd:80, dmg:22, xp:250,r:28, shoots:true, shotCd:0.8, boss:true,
    phases:[ { at:1.0, pattern:'spread', shotCd:0.8 },
  ...
  bane:      { nm:'The Hon. Mortimer Bane', hp:800, spd:65,  dmg:20, xp:400,r:28, shoots:true,  shotCd:0.9, boss:true,
    phases:[ { at:1.0, pattern:'spread', shotCd:0.9 },
             { at:0.6, pattern:'aimed3', shotCd:0.7, spd:1.15, say:'BANE: "OVERRULED. This court will not be RUSHED."' },
             { at:0.3, pattern:'spiral', shotCd:0.55, spd:1.25, say:'BANE: "ORDER. ORDER! The gavel falls for THEE."' } ] },
  instrument:{ nm:'The Founding Agreement', hp:1100,spd:48,  dmg:24, xp:600,r:30, shoots:true,  shotCd:0.7, boss:true, resist:0.30,
    phases:[ { at:1.0, pattern:'spread', shotCd:0.7 },
             { at:0.66, pattern:'ring', shotCd:1.0, say:'The Founding Agreement unfurls its codicils.' },
             { at:0.33, pattern:'spiral', shotCd:0.5, spd:1.2, say:'THE AGREEMENT: every clause demands satisfaction.' } ] },
};
